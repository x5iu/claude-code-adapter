...
//go:generate go tool github.com/x5iu/defc generate --output provider_impl.go --features api/ignore-status,api/get-body,api/retry,api/gzip --func json_encode=utils.JSONEncode --func get_config=viper.GetString
